...
import { Check, MapPin, UserCheck, UserX, Calendar, Globe, Users } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <Card className="overflow-hidden">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <div className="text-center">
              <div className="text-2xl font-bold text-devhub-purple">{followersCount}</div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-devhub-purple">{followingCount}</div>
              <div className="text-sm text-gray-500 dark:text-gray-400 flex items-center justify-center gap-1">
                <Users className="h-4 w-4" />
                Подписок
              </div>
