...
const SnippetActions = ({
  ...
  return <div className="flex items-center space-x-2">
      <Button variant="ghost" size="sm" className={`flex items-center ${liked ? 'text-red-500 dark:text-red-400' : ''}`} onClick={handleLike}>
      ...
      <Button variant="ghost" size="sm" className={`flex items-center ${saved ? 'text-yellow-500 dark:text-yellow-400' : ''}`} onClick={handleSave}>
