...
import { Github, Twitter, Linkedin, MessageCircle, ExternalLink, Send } from 'lucide-react';
...
const SocialMediaLinks: React.FC<SocialMediaLinksProps> = ({
  ...
  const links = [
    ...
    {
      url: twitter ? (twitter.startsWith('http') ? twitter : `https://twitter.com/${twitter}`) : null,
